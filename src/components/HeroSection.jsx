...
export default function HeroSection() {
  return (
    <section className="relative w-full justify-center min-[1201px]:h-[100vh] min-[1201px]:min-h-[100vh] min-[1201px]:py-5 flex">
        ...
        <div className="z-1 relative flex max-md:flex-col-reverse max-md:items-center justify-between max-w-[1250px] min-[1201px]:w-auto min-[1201px]:max-w-[1440px]">
            ...
            <div className="w-[50%] max-md:w-full flex items-center justify-center relative">
                ...
                <div className="relative flex items-center">
                    <img src="../src/assets/star_circle.png" className="absolute rotate w-[310px] max-[1200px]:w-[210px] drop-shadow-[0px_0px_10px_#ffff33] top-[15%] left-[27%] float-left min-[1201px]:top-[16%] min-[1201px]:left-[28%] z-[-1]" alt="" />
                    <img src="../src/assets/pink_circle.png" className="absolute w-[380px] max-[1200px]:w-[260px] drop-shadow-[0px_0px_10px_#f31aa0] top-[10%] left-[21%] float-left min-[1201px]:top-[12%] min-[1201px]:left-[23%] z-[-1]" alt="" />
                    <img src="../src/assets/purple_circle.png" className="absolute rotateReverse w-[430px] max-[1200px]:w-[290px] drop-shadow-[0px_0px_10px_#622cf7] top-[6%] float-left left-[17%] min-[1201px]:top-[8%] min-[1201px]:left-[19%] z-[-1]" alt="" />
